...
export const GOOGLE_APIS = [
	...
	},
	{
		...
		scopes: [
			{
				id: "https://www.googleapis.com/auth/agentregistry.read-only",
				description:
	...
	},
	{
		...
		scopes: [
			...
			{
				id: "https://www.googleapis.com/auth/chat.users.sections",
				description:
